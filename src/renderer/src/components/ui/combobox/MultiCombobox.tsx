...
interface Props extends FieldFeedbackProps { id?: string; label: string; mode?: FieldMode; controlSize?: FieldControlSize; labelVisibility?: LabelVisibility; values: string[]; options: ComboboxOption[]; onChange: (values: string[]) => void; onOpen?: () => void; placeholder?: string; searchable?: boolean; showChips?: boolean; disabled?: boolean; loading?: boolean; loadingMessage?: string; emptyMessage?: string; invalidationKey?: unknown; allowCustomValue?: boolean }
