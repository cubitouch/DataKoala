...
export interface AppState {
  ...
  setLokiState: (patch: Partial<Pick<QuerySession, 'lokiTimeRange' | 'lokiBuilder' | 'lokiResultLimit' | 'lokiDisplayDirection' | 'lokiGroupBy' | 'lokiResultView' | 'lokiRangeHistory'>>, tabId?: string) => void
